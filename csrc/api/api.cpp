...
#include "dense_fwd.h"
#include "block_sparse_bwd.h"
#include "block_sparse_fwd.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("block_sparse_prefill_bwd", &block_sparse_prefill_bwd);
    m.def("block_sparse_bwd_workspace_size", &block_sparse_bwd_workspace_size);
    m.def("block_sparse_prefill_fwd", &block_sparse_prefill_fwd);
}
